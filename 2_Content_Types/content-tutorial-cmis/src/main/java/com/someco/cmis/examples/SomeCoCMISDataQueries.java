...
public class SomeCoCMISDataQueries extends CMISExampleBase {
	...
	public void doExamples() {
		...
		// Query returning instances of sc:doc and children 
		...
		//objects containing word "sample"
		System.out.println(RESULT_SEP);
		...
		//Shows active objects
		//Active is an aspect, and alfresco doesn't allow joins except for aspects
		//Alfresco CMIS uses joins to relate a base type to one of its aspects
		System.out.println(RESULT_SEP);
		...
		//Search for active objects with a certain aspect
		// 2 queries are recquired for that
		System.out.println(RESULT_SEP);
		...
		//Query for dateranges
		//sc:whitepapers witihin a daterange
		System.out.println(RESULT_SEP);
